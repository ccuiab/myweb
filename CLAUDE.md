...
2025/05/08 从"暖色文艺"改为"工业机甲风"：

| 元素 | 色值 | 说明 |
|------|------|------|
| 侧边栏背景 | `#0f1115` | 枪铁灰 |
| 主强调色 | `#ff6b35` | 熔岩橙 |
| 辅助强调色 | `#e85d2b`, `#cc5529`, `#b87333` | 橙系不同明度 |
| 卡片背景 | `rgba(20,22,28,0.78)` | 深灰毛玻璃 |
| 子卡片背景 | `rgba(30,32,38,0.60)` | 更深灰 |
| 正文色 | `#d8dde4` | 浅灰（适配深色卡片） |
| 背景滤镜 | `brightness(0.6) saturate(0.8) contrast(1.1)` | 冷色暗化+锐化 |
